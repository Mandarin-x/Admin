	...
	<div class="container">
		...
		<div class="row flex">
			...
			<div class="col-xs-12 col-sm-5 col-md-4 flex">
				<a href="index.html">
					<!-- Logo -->
				    <a href="index.html"></a><a href="index.html"></a><a href="index.html"></a></a><a href="index.html"></a><a href="index.html"></a><a href="index.html"><img src="../images/logo.png" alt="PhotoMarket" width="281" height="112" class="logo img-responsive"></a></div>
			...
			<div class="col-xs-12 col-sm-7 col-md-8 flex flex-center">
				...
				<ul class="nav nav-pills">
					...
					<li role="presentation"><a href="#" class="cart-icon">join us </a></li>
					<li role="presentation"></li>
					<li class="cart-icon" role="presentation"><a href="login.jsp">log in</a></li>
				</ul>
